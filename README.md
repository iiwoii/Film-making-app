# Создание фильмов на базе художественных произведений авторов
  ...
  3. Подход к моделированию: какие модели (имена нейросетей, библиотек) вы будете использовать в решении вашей задачи, какова будет конфигурация решения? Можно приложить схему.
     ...
     Имена нейросетей: OpenAI models:  ChatGPT (если бесплатное решение) или другие Open-AI content generation APIs, как Sora( в случае использования платных решений).
     
     Библиотеки: mutagen, gTTS, PIL, moviepy и др.

     Конфигурация решения:
     
     1.) использование OpenAI API для использования возможностей готовых нейросетей.
